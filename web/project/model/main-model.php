...
function getCharactersHTML($characters) {
    ...
    if(count($characters) > 0) {
        ...
        foreach ($characters as $character => $characterInfo) {
            $charactersHTML .= "<div class='character' characterid='$characterInfo[charid]'>";
...
function getCharacterHTML($characters) {
    ...
    if(count($characters) > 0) {
        ...
        foreach ($characters as $character => $characterInfo) {
            ...
            $charactersHTML .= "<input type='hidden' name='action' value='manage'>";
            $charactersHTML .= "<button type='submit' name='edit' value='$characterInfo[charid]'>Edit</button>";
            $charactersHTML .= "<button type='submit' name='delete' value='$characterInfo[charid]'>Delete</button>";
            $charactersHTML .= "</form>";
            $charactersHTML .= "</div>";
            $charactersHTML .= "</div>";
        }
