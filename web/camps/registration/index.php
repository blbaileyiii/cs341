...
require_once $_SERVER['DOCUMENT_ROOT'] . '/camps/models/reg-model.php';
...
switch($action){
    case 'confirm':
        ...
        */
        ...
        if(empty($participantDOB)){
            ...
            include $_SERVER['DOCUMENT_ROOT'] . '/camps/view/registration.php';
            exit; 
        }
    ...
    case 'Register':
        ...
        */
        ...
        if($regId){            
            ...
            header('Location: /camps/registration/');
            exit;
        } else {
    ...
    case 'backdoor':
        ...
        // Note: NO BREAK; or EXIT; This allows this setup to continue to the default...
    default:
