...
function getRegistrants() {
    try {
        ...
        $sql = 
        'SELECT e.key, e.name, r.p_ward, r.p_name, r.p_age, r.p_shirt_size, r.email, r.tele_one, r.tele_one_type, r.emer_name, r.emer_tele_one, r.emer_tele_one_type, r.inactivated
