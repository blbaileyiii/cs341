...
<body>
    ...
    <main>
        ...
        <?php require $_SERVER['DOCUMENT_ROOT'] . '/camp2021/common/faq.php'; ?>
        <?php require $_SERVER['DOCUMENT_ROOT'] . '/camp2021/common/scripture.php'; ?>
        <?php require $_SERVER['DOCUMENT_ROOT'] . '/camp2021/common/contact.php'; ?>
        <?php require $_SERVER['DOCUMENT_ROOT'] . '/camp2021/common/guidelines.php'; ?>
    </main>
    <footer>
