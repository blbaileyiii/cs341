                ...
                <div>
                    <fieldset>
                        ...
                        <div class="fields">
                            ...
                            <input id="participantESig" name="participantESig" type="text" required>
                        ...
                        <div class="fields">
                            <label for="guardianSig"><span>Parent or guardian's E-signature (Use your finger or mouse to sign inside the box below)</span><?php if(isset($participantAge) && $participantAge >=19){ echo "";} else {echo "<span class='field-tip'>Required</span>";} ?></label> 
