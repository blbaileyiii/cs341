            ...
            <form <?php if(isset($validate)){echo "class='form validate'";} else { echo "class='form'"; } ?> method="post">
                ...
                <div>
                    <fieldset>
                        ...
                        <div class="fields">
                            <label><span>Parent or guardian's E-signature (Use your finger or mouse to sign inside the box below)</span><?php if(isset($participantAge) && $participantAge >=19){ echo "";} else {echo "<span class='field-tip'>Required</span>";} ?></label> 
                ...
                <div class="non-fields">
                        <button name="action" type="submit" value="Register"><span>Next: Confirmation</span></button>
                </div>
            </form>
        </section>
    </main>
